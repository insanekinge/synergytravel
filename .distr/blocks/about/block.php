	...
	<div class="container">
		<div class="about__inner">
            <div class="about__header">
                <h2 class="about__header-title">О нас</h2>
                <div class="about__header-right">
                    <div class="about__header-right_text">Узнайте больше о наших турах</div>
                    <div class="about__header-right_button">Смотреть все</div>
                </div>
            </div>
			<div class="about__content">
				<div class="about__info">Концепция</div>
				<p class="about__text">
			...
			<form class="about__form" id="aboutForm">
                <div class="about__form-info">Связь с нами</div>
				<h3 class="about__form-title">Заполните форму заявки</h3>
				<div class="about__form-row">
					<div class="about__form-group">
						<input type="text" class="about__form-input" id="aboutName" name="name" placeholder="Имя" required>
					</div>
					<div class="about__form-group">
						<input type="tel" class="about__form-input" id="aboutPhone" name="phone" placeholder="Телефон" required>
					</div>
				</div>
                <p class="about__form-text">и мы свяжемся с вами в ближайшее время</p>
